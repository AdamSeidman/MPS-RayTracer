...
#SBATCH --mail-user=sjk7867@rit.edu
...
# **********************************************************************
# Sequential
srun -n $SLURM_NPROCS ./raytrace_mpi -h 600 -w 600 -c configs/twhitted.xml -p static_strips_horizontal
